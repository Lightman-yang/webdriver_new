        ...
        for i in range(1, 60):
            ...
            for j in range(1, 9):
                ...
                if j == 1:
                    ...
                    time.sleep(0.75)
                    self.FuBen_INFO1()
                    self.forxunhuanC(sss, aa1, bb1, cc1, dd1, hh1, hh2,-10)
...
if __name__ == '__main__':
    ...
    for aa in range(4, 9):  # 打图设置ddddg
        ...
        if aa == 0:
            ...
            if pvp == 1:
                c.yuren(n, 0.54, 0.26, 0, 0, *canshu)  # 1p 悟空师很烂 缪斯
