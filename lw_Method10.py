...
class Caozuolei(Caozuolei1):
    ...
    def FuBen_INFO66(self, ss=0):  # 副本地图信息数据实时获取
        ...
        while True:
            ...
            elif '开府' in str(aa00) or '开府' in str(aa12) or '开府' in str(aa11):
                if sss2 == 2:
        ...
        for i in range(1, 60):
            ...
            for j in range(1, 9):
                ...
                if j == 1:
                    ...
                    xxyy[3] = 4
                    #xxyy = [1, 2, 3, 4, 99, 6]
                    t3 = Thread(target=self.forxunhuanY,args=(sss, aa1, bb1, cc1, dd1, hh1, hh2))  # 定义线程t2，线程任务为调用task2函数，task2函数无参数
                    t3.start()  # 开始运行t1线程
                    dt.keyUp('right')  # ：模拟按键松开按键
                    time.sleep(0.65)
                    # self.forxunhuanY(sss, aa1, bb1, cc1, dd1, hh1, hh2)
    ...
    for aa in range(1, 5):  # 打图设置ddd
        ...
        if aa == 0:
            ...
            if pvp == 1:
                ...
                c.zhaohuan(n, 0.99, 0.26, 0, 0, *canshu)  # 2p 睡眠不足十
                break
            ...
            if pvp == 1:
                ...
                c.kuangzhanshi2(n, 0.4, 0.3, 0.26, 0, 0, *canshu)  # 1p  阿修罗
