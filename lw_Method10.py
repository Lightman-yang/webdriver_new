        ...
        for i in range(1, 60):
            ...
            for j in range(1, 9):
                ...
                if j == 1:
                    ...
                    dt.press('ctrl')
                    time.sleep(3)  # 按下两秒
                    for aaa in range(1,9):
                        time.sleep(0.45)  # 按下19秒g
                        dt.press('q')
                        dt.press('r')
                        dt.press('alt')
...
if __name__ == '__main__':
    ...
    # print(pvp)
    # time.sleep(1000)
    # x = [[150, 290, 1], [2170, 280, 2], [380, 215, 3], [490, 215], 4, [719, 285, 5], [80, 501, 6]]
    x = [[134, 231, 1], [274, 258, 2], [412, 244, 3], [556, 247, 4], [691, 256, 5], [67, 464, 6], [204, 466, 7],
         [350, 487, 8]]
    for aa in range(4, 5):  # 打图设置ddddg
        ...
        time.sleep(5)
        if x[aa][2] == 6 or x[aa][2] == 7 or (pvp == 3 and x[aa][2] == 3) or (pvp == 2 and x[aa][2] == 8):
        ...
        if aa == 0:
            ...
            if pvp == 1:
                c.nvQiGong(n, 0.5, 0.265, 0, 0, *canshu)  # 1p 气功师很懒
                # c.nvQiGong(n, 0.62, 0.26, 0)  # 2p 睡眠不足丶
                #
            elif pvp == 2:
                c.nvQiGong(n, 0.52, 0.3, 1, 0, *canshu)  # 2p 睡眠不足丶
            else:
