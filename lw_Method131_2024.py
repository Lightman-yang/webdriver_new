...
class Caozuolei(Caozuolei1):
    ...
    def JunhengzhongMaoSi(self):  # 均衡仲裁者地图
        for kk in range(1, 60):
            global ret_values
            ret_values = [9, 8, 7]
            t13 = Thread(target=self.FuBen_INFO3,
            ...
            for i in range(1, 60):
                ...
                if ret_values[0] == 1:
                    ...
                    print('111')
    def JunhengzhongYuRen(self):  # 均衡仲裁者地图
        for kk in range(1, 60):
            global ret_values
            ret_values = [9, 8, 7]
            t13 = Thread(target=self.FuBen_INFO3,
        ...
        for kk in range(1, 60):
            ...
            for i in range(1, 60):
                ...
                if ret_values[0] == 1:
                    ...
                    dt.PAUSE=random.uniform(0.04,0.05)
    ...
    def JunhengzhongNvQiGong(self):  # 均衡仲裁者地图
        for kk in range(1, 60):
            global ret_values
            ret_values = [9, 8, 7]
            t13 = Thread(target=self.FuBen_INFO3,
            ...
            for i in range(1, 60):
                ...
                if ret_values[0] == 1:
                    ...
                    print('111')
    def ShingDian(self,xx=0):  # 圣殿贝里科蒂斯地图
        for kk in range(1, 60):
            global ret_values
            ret_values = [9, 8, 7]
            t13 = Thread(target=self.FuBen_INFO3,
